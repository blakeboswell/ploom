...
# font family needs to available on system
# font_family <- "UbuntuMonoDerivativePowerline-Regular"
...
Although the runtimes are comparable, `oomlm()` is slightly faster than `lm()`.  This indicates that there is no runtime penalty for using the scalable fitting of `oomlm()` even when working with `lm()` scale data.
