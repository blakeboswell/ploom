...
Models are initalized with a call to `ylm` and updated with `update`.   The recommended pattern is to initialize models without referencing the data, then call `update` on each data chunk in the exact same way.
